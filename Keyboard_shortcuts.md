...
Since SVN r4704, Fluxbox now handles mouse events in the keys file. ([details](How_to_build_fluxbox_from_source#What_is_git_version_and_why_should_I_use_it.3F "wikilink"))
...
:\* 8 cycle linear (use the same order every time) For example, the following will skip any window that's, stuck or shaded since 6 = 4 + 2.
...
Refer to posts here: [1](https://bbs.archlinux.org/viewtopic.php?pid=624950)
