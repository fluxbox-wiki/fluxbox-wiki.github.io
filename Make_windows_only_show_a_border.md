...
Now save and choose ''reconfigure'' or ''restart'' from the rootmenu, all apps will show ONLY a border now (if the styles uses one).
You can also change the pixelwidth and the color of the border.

Either do it globally using the [http://fluxbox-wiki.org/index.php/Howto_style_overlay overlay file] or separately for every single style.
