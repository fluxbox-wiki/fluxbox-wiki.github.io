...
The default '''~/.fluxbox/startup''' file which is used by '''startfluxbox''' looks like the following:
(If you don't have it, make sure you start fluxbox with '''startfluxbox''')
 #!/bin/sh
 #
