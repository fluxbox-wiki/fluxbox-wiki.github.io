...
If your on debian distro you need to '''touch ~/.Xsession''' use your favorite editor edit ~/.Xsession and put '''exec /usr/bin/startfluxbox'''  then save the file  
and restart your GDM session. 
...
To customize the startup script see [[Howto edit the startup file|this page]] You will find information explaining how to start applications at startup, how to execute apps automatically after fluxbox has already started, and other topics.