...
* [https://launchpad.net/grandr grandr]
* [http://albertomilone.com/urandr.html urandr]
* [http://kde-apps.org/content/show.php/xramdr?content=70521 xramdr]
...
Now you have to add the mode you want to use to the '''beginning''' to all those Modes lists. So if you want to use 1024x768 instead of 1600x1200 (that one is the first so it will be used as the display supports it), 
