...
If something fbot or computer tells you is a broken or dead link, or the info is just totally wrong, please inform someone in the room who can correct it; like errr, hnaz, dopey, meltir, or one of the [http://fluxbox-wiki.org/index.php/Faqs#Who_are_the_developers developers]

===Factoids===
See the [http://fluxbox-wiki.org/index.php?title=How_to_work_the_bots/Factoids factoids] page for the whole list of fbot's keywords!