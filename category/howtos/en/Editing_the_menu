...
Long story short. Use [http://fluxbox-wiki.org/index.php?title=FluxMenu fluxMenu]. It is old but should work just fine.
Or [http://fluxbox-wiki.org/index.php?title=Fluxbox_Menu_Editor_(en) Fluxbox Menu Editor (FME)]