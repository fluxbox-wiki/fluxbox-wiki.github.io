...
Xdefaults is the old name, still used as convention, but it's called [http://lists.debian.org/debian-user/2005/09/msg01385.html Xresources] since years and located in the users $HOME as a hidden file.
If you don't have this file it's normal. Most people will have to create it before it is there.
...
Add
 $ xrdb ~/.Xresources
in your ~/.fluxbox/startup and remember to launch fluxbox with [[startfluxbox]].
